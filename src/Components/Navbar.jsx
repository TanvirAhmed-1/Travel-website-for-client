    ...
    <div>
      <div className="navbar bg-base-100 py-5">
        <div className="navbar-start">
          ...
          <Link to={"/"}>
            <h2 className="btn btn-ghost text-xl font-pasicfico">
              Travel Way{" "}
            </h2>
          </Link>
        </div>
        ...
        <div className="navbar-end gap-2">
          ...
          {user?.photoURL ? (
            <img className="rounded-lg w-12" src={user.photoURL} alt="" />
          ) : (
            " "
          )}
          {user ? (
            <h2
              ...
              className="btn bg-yellow-400 rounded-lg border-none text-black"
            >
              Logout
            </h2>
          ) : (
            <Link to={"/login"}>
              {" "}
              <h2 className="btn rounded-lg bg-yellow-400 border-none text-black">
                Login
              </h2>
            </Link>
          )}
